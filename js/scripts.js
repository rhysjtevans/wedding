$(document).ready(function () {
    ...
    $('#btn-show-map-villa').click(function () {
        $('#map-content-villa').toggleClass('toggle-map-content');
        $('#btn-show-content-villa').toggleClass('toggle-map-content');
    });
    $('#btn-show-content-villa').click(function () {
        $('#map-content-villa').toggleClass('toggle-map-content');
        $('#btn-show-content-villa').toggleClass('toggle-map-content');
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Just a sec!</strong> I\'m writing them down!'));
...
function initMap() {
    ...
    var silverfieldVenue = {lat: 37.0963943, lng: -3.5779971};
    var mapVilla = new google.maps.Map(document.getElementById('map-canvas-villa'), {
        zoom: 15,
        center: silverfieldVenue,
        scrollwheel: false,
        draggable: true,
        fullscreenControl: true
    });

    var markerVilla = new google.maps.Marker({
        position: silverfieldVenue,
        map: mapVilla,
    ...
    // directionsDisplay.setMap(mapVilla);
    // // directionsDisplay.setPanel(document.getElementById('panel'));

    // var request = {
    // origin: 'Granada, Spain', 
    // destination: 'Silverfield villa, granada, spain',
